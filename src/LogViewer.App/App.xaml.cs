...
public partial class App : Application
{
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        services.AddSingleton<LogViewer.Core.Annotations.ILineAnnotationStore>(
            _ => new LogViewer.Core.Annotations.LineAnnotationStore(LogViewer.Core.Annotations.LineAnnotationStore.DefaultPath));
        services.AddSingleton<LogViewer.Core.Tailing.IContainerCli, LogViewer.Core.Tailing.ContainerCli>();
